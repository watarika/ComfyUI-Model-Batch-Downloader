...
Hugging Face、Civitai、任意のHTTP/HTTPS URLから複数のComfyUIモデルファイルを`aria2c`で取得し、同じComfyUIキュー内でロードするカスタムノードです。チェックポイント、diffusion model、text encoder、VAE、LoRAに対応しています。
